...
- **Primary**: Clean whites and deep blacks for contrast
- **Accents**: Gradient blues, greens, and purples for data visualization
- **Status Colors**: Green (optimal), Blue (good), Yellow (warning), Red (critical)


### Typography

- **Font**: Inter for clean, professional readability
- **Hierarchy**: Clear heading structure with consistent spacing
- **Emphasis**: Gradient text effects for key metrics and CTAs


### Components

- **Cards**: Gradient backgrounds with hover animations
- **Buttons**: Smooth transitions with scale effects
- **Progress Bars**: Animated fills with gradient colors
- **Badges**: Status-based color coding with subtle animations
